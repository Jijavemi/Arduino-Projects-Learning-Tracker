...
- Serial.begin(9600)             this is how we connect the string input to the Serial Monitor
- Serial.println();              prints out value. 

- pinMode(pin, mode)             pin is the PIN we want to configure, Mode is the behavior the pin uses
